...
export default function HighlightsSection() {
  return (
    <section id="highlights" className="py-20 bg-white text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-6 md:px-16 max-w-7xl mx-auto">
        {highlights.map((item) => (
          <div
            key={item.id}
            className="bg-white border-4 border-[#FF6B35] rounded-2xl p-8 flex flex-col items-center justify-center space-y-4 hover:shadow-lg transition-shadow"
          >
