...
export default function HeroSection() {
  ...
  // render confetti only after mount to avoid any hydration surprises
  ...
  const slides = [
    ...
    { src: assetPath("/Tabur_tickets.png"), alt: "Tickets preview", type: "image" as const },
    {
      ...
      contain: true,
      type: "video" as const,
      poster: assetPath("/kids_running_field.png"),
    },
    {
      src: assetPath("/TGIFC_teaser.mp4"),
      alt: "TGIFC teaser 2",
      contain: true,
      type: "video" as const,
      poster: assetPath("/kids_running_field.png"),
  ...
  return (
    <section className="relative pt-32 md:pt-32 pb-16 px-6 md:px-16 bg-white overflow-hidden">
      {/* Confetti */}
      {showConfetti && (
      ...
      <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl">
            {/* Gurgaon */}
            <div className="rounded-xl border-2 border-[#81B622] bg-white p-4 text-left shadow-sm h-full flex flex-col">
              ...
              <div className="mt-2 flex items-start gap-2 text-[#1C1C1C]">
                <svg className="w-5 h-5 text-[#81B622] mt-0.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7zm0 9.5A2.5 2.5 0 1 1 12 6a2.5 2.5 0 0 1 0 5.5z"/>
                </svg>
                <p className="leading-snug">
                  Tau Devilal Stadium, Gurugram
                </p>
              </div>
            ...
            {/* <div className="rounded-xl border-2 border-[#FFD23F] bg-white p-4 text-left shadow-sm h-full flex flex-col">
              ...
              <div className="mt-2 flex items-start gap-2 text-[#1C1C1C]">
                <svg className="w-5 h-5 text-[#FFD23F] mt-0.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d="M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7zm0 9.5A2.5 2.5 0 1 1 12 6a2.5 2.5 0 0 1 0 5.5z"/>
                </svg>
                <p className="leading-snug">
